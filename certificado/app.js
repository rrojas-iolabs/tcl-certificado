...
exports.lambdaHandler = function (event, callback) {
  ...
  createCertificate(event, fileName);
}

function createCertificate(certificate, fileName) {
  ...
  generateSignature(doc, certificate);
...
function generateSignature(doc, certificate) {
  doc
    //.image("firma-izquierda.jpeg", 200, 550, { width: 200, align: "center" })
